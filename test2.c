...
int main() {
    ...
    for (int i=0; i<4; ++i){
        ...
        //cores[i].axons = malloc(256 * sizeof(struct axon));
    }
    cores[4].neurons = malloc(250 * sizeof(struct neuron));

    //struct core core5;
    //core5.neurons = malloc(250 * sizeof(struct neuron));
    //core5.axons = malloc(256 * sizeof(struct axon));
